            ...
            <div className='mt-10 md:mt-20 flex flex-col-reverse md:flex-row gap-10 md:gap-40 items-center justify-center px-6 md:px-0'>
                <div className='text-center md:text-left'>
                    ...
                    <div className='flex flex-row gap-4 mt-8 justify-center md:justify-start'>
                        <a href="/cv-jarod.pdf" target="_blank" rel="noopener noreferrer" className='px-6 md:px-8 py-2 btn-gradient text-white rounded-full font-poppins text-base md:text-lg flex items-center gap-2'>
                            Voir mon CV
                        ...
                        <div className='flex flex-row gap-2'>
                            <a href="https://github.com/JarodT77" target="_blank" rel="noopener noreferrer" className='glass-circle'>
                                <img src={github} alt="GitHub" className='w-10' />
                            </a>
                            <a href="mailto:thongkhamdyjarod@gmail.com" className='glass-circle'>
                                <img src={gmail} alt="gmail" className='w-10' />
                            </a>
                            <a href="www.linkedin.com/in/jarod-thongkhamdy-ba168119b" target="_blank" rel="noopener noreferrer" className='glass-circle'>
